...
If the sample is not representative, the conclusions from the data cannot
...
```{r data_manhattan}
manhattan <- read_csv("/Applications/lecture-note-class-13-jonahcagley/manhattan.csv")
```
...
We are 95% confident that the mean will land between 2299 and 2977.
...
We are 95% confident that the mean will fall between .690 and .793.
